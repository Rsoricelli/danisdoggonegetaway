...
if (!themerex_sc_param_is_off($sidebar_show) && is_active_sidebar($sidebar_name)) {
	?>
			...
			if (themerex_get_custom_option('sidebar_outer_show_menu')=='yes') {
				...
				if (!empty($THEMEREX_GLOBALS['menu_side']))	{
					...
					<div class="sidebar_outer_menu">
						<?php echo ($THEMEREX_GLOBALS['menu_side']); ?>
						<span class="sidebar_outer_menu_buttons">
						<a href="<?php echo esc_url( '#' ); ?>" class="sidebar_outer_menu_responsive_button icon-menu"></a>
						<?php if (themerex_get_custom_option('sidebar_outer_show_widgets')=='yes') { ?>
						<a href="<?php echo esc_url( '#' ); ?>" class="sidebar_outer_widgets_button icon-book-open"></a>
						<?php } ?>
						</span>
					</div>
					<?php

...
if ( !function_exists( 'themerex_template_single_standard_output' ) ) {
	function themerex_template_single_standard_output($post_options, $post_data) {
		...
		if ($show_title && $post_options['location'] == 'center' && themerex_get_custom_option('show_page_title')=='yes') {
			?>
        ...
        if ($post_options['location'] == 'center' && !$post_data['post_protected'] && themerex_get_custom_option('show_post_info')=='yes') {
        ...
        if ($post_options['location'] == 'center' && !$post_data['post_protected'] && themerex_get_custom_option('show_post_info')=='yes') {
            $info_parts = array( 'date' => false, 'author' => false, 'comments' => true ,'terms' => false, 'counters' => true );

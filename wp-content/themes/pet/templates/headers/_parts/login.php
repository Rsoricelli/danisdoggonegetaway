	...
	<div class="form_wrap">
		<div class="form_left">
			<form action="<?php echo wp_login_url(); ?>" method="post" name="login_form" class="popup_form login_form">
				...
				<div class="popup_form_field login_field iconed_field icon-user"><input type="text" id="log" name="log" value="" placeholder="<?php _e('Login or Email', 'themerex'); ?>"></div>
				<div class="popup_form_field password_field iconed_field icon-lock"><input type="password" id="password" name="pwd" value="" placeholder="<?php _e('Password', 'themerex'); ?>"></div>
		...
		<div class="form_right">
			...
			<div class="login_socials_list">
				<?php echo do_shortcode('[trx_socials size="tiny" shape="round" socials="facebook=#|twitter=#|gplus=#"][/trx_socials]'); ?>
			</div>

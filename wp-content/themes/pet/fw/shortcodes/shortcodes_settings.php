		...
		if (themerex_shortcodes_is_used()) {
			...
			$THEMEREX_GLOBALS['shortcodes'] = array(
				...
				"trx_accordion" => array(
					...
					"params" => array(
                        ...
                        "icon_before_title" => array(
                            ...
                            "desc" => __('Select icon. Visible if the Accordion Style 2',  'themerex'),
                            "value" => "",
                            "type" => "icons",
				...
				"trx_blogger" => array(
					...
					"params" => array(
						...
						"cat" => array(
							...
							"style" => "list",
							"multiple" => true,
							"options" => themerex_array_merge(array(0 => __('- Select category -', 'themerex')), $THEMEREX_GLOBALS['sc_params']['categories'])
						),
						"count" => array(
				...
				"trx_call_to_action" => array(
					"title" => __("Call to action", "themerex"),
					"desc" => __("Insert call to action block in your page (post)", "themerex"),
					"decorate" => true,
					"container" => true,
					"params" => array(
						"title" => array(
						...
						"style" => array(
							...
							"desc" => __("Select style to display block", "themerex"),
							"value" => "1",
							"type" => "checklist",
							"options" => themerex_get_list_styles(1, 2)
						),
						"align" => array(
							...
							"desc" => __("Alignment elements in the block", "themerex"),
							"value" => "",
							"type" => "checklist",
							"dir" => "horizontal",
							"options" => $THEMEREX_GLOBALS['sc_params']['align']
						...
						"accent" => array(
							"title" => __("Accented", "themerex"),
							"desc" => __("Fill entire block with Accent1 color from current color scheme", "themerex"),
							"divider" => true,
							"value" => "no",
							"type" => "switch",
							"options" => $THEMEREX_GLOBALS['sc_params']['yes_no']
						...
						"custom" => array(
							...
							"desc" => __("Allow get featured image or video from inner shortcodes (custom) or get it from shortcode parameters below", "themerex"),
							"divider" => true,
							"value" => "no",
							"type" => "switch",
							"options" => $THEMEREX_GLOBALS['sc_params']['yes_no']
						...
						"image" => array(
							...
							"desc" => __("Select or upload image or write URL from other site to include image into this block", "themerex"),
							"divider" => true,
							"readonly" => false,
							"value" => "",
							"type" => "media"
						...
						"video" => array(
							...
							"desc" => __("Select video from media library or paste URL for video file from other site to include video into this block", "themerex"),
							"readonly" => false,
							"value" => "",
							"type" => "media",
							"before" => array(
						...
						"link2" => array(
							"title" => __("Button 2 URL", "themerex"),
							"desc" => __("Link URL for the second button at the bottom of the block", "themerex"),
							"divider" => true,
							"value" => "",
							"type" => "text"
						),
						"link2_caption" => array(
							"title" => __("Button 2 caption", "themerex"),
							"desc" => __("Caption for the second button at the bottom of the block", "themerex"),
							"value" => "",
							"type" => "text"
						),
						"width" => themerex_shortcodes_width(),
				...
				"trx_contact_form" => array(
					...
					"params" => array(
						...
						"style" => array(
							"title" => __("Style", "themerex"),
							"desc" => __("Select style of the contact form", "themerex"),
							"value" => 1,
							"options" => themerex_get_list_styles(1, 2),
							"type" => "checklist"
						), 
				...
				"trx_googlemap" => array(
					...
					"desc" => __("Insert Google map with specified markers", "themerex"),
					"decorate" => false,
					"container" => true,
					"params" => array(
						"zoom" => array(
					...
					"children" => array(
						...
						"desc" => __("Google map marker", "themerex"),
						"decorate" => false,
						"container" => true,
						"params" => array(
							"address" => array(
								"title" => __("Address", "themerex"),
								"desc" => __("Address of this marker", "themerex"),
								"value" => "",
								"type" => "text"
							),
							"latlng" => array(
								"title" => __("Latitude and Longtitude", "themerex"),
								"desc" => __("Comma separated marker's coorditanes (instead Address)", "themerex"),
								"value" => "",
								"type" => "text"
							),
							"point" => array(
								"title" => __("URL for marker image file", "themerex"),
								"desc" => __("Select or upload image or write URL from other site for this marker. If empty - use default marker", "themerex"),
								"readonly" => false,
								"value" => "",
								"type" => "media"
							),
							"title" => array(
								"title" => __("Title", "themerex"),
								"desc" => __("Title for this marker", "themerex"),
								"value" => "",
								"type" => "text"
							),
							"_content_" => array(
								"title" => __("Description", "themerex"),
								"desc" => __("Description for this marker", "themerex"),
								"rows" => 4,
								"value" => "",
								"type" => "textarea"
							),
				...
				"trx_image" => array(
					...
					"params" => array(
						...
						"link" => array(
							...
							"desc" => __("The link URL from the image", "themerex"),
							"value" => "",
							"type" => "text"
						),
						"width" => themerex_shortcodes_width(),
				...
				"trx_price_block" => array(
					...
					"params" => array(
                        ...
                        "color" => array(
                            "title" => __("Color background", "themerex"),
                            "desc" => __("Select color background for this block", "themerex"),
                            "value" => "",
                            "type" => "color"
                        ),
						"align" => array(
				...
				"trx_quote" => array(
					...
					"params" => array(
                        ...
                        "style" => array(
                            "title" => __("Style quote", "themerex"),
                            "desc" => __("Select design", "themerex"),
                            "value" => 1,
				...
				"trx_search" => array(
					...
					"params" => array(
						...
						"state" => array(
							"title" => __("State", "themerex"),
							"desc" => __("Select search field initial state", "themerex"),
							"value" => "fixed",
							"options" => array(
								"fixed"  => __('Fixed',  'themerex'),
								"opened" => __('Opened', 'themerex'),
								"closed" => __('Closed', 'themerex')
							),
							"type" => "checklist"
						),
						"title" => array(
				...
				"trx_skills" => array(
					...
					"params" => array(
						...
						"arc_caption" => array(
							"title" => __("Arc Caption", "themerex"),
							"desc" => __("Arc caption - text in the center of the diagram", "themerex"),
							"dependency" => array(
								'type' => array('arc')
							),
							"value" => "",
						...
						"pie_compact" => array(
							"title" => __("Pie compact", "themerex"),
							"desc" => __("Show all skills in one diagram or as separate diagrams", "themerex"),
							"dependency" => array(
								'type' => array('pie')
							),
							"value" => "no",
						...
						"pie_cutout" => array(
							"title" => __("Pie cutout", "themerex"),
							"desc" => __("Pie cutout (0-99). 0 - without cutout, 99 - max cutout", "themerex"),
							"dependency" => array(
								'type' => array('pie')
							),
							"value" => 0,
					...
					"children" => array(
						...
						"params" => array(
							...
							"style" => array(
								"title" => __("Counter style", "themerex"),
							...
							"icon" => array(
								"title" => __("Counter icon",  'themerex'),
								"desc" => __('Select icon from Fontello icons set, placed above counter (only for type=counter)',  'themerex'),
								"value" => "",
								"type" => "icons",
								"options" => $THEMEREX_GLOBALS['sc_params']['icons']
							),
				...
				"trx_slider" => array(
					...
					"params" => array_merge(array(
						...
						"cat" => array(
							...
							"desc" => __("Select category to show post's images. If empty - select posts from any category or from IDs list", "themerex"),
							"dependency" => array(
								'engine' => array('swiper')
							),
							"divider" => true,
				...
				"trx_socials" => array(
					...
					"params" => array(
						"type" => array(
							...
							"desc" => __("Type of the icons - images or font icons", "themerex"),
						...
						"shape" => array(
							"title" => __("Icon's shape", "themerex"),
							"desc" => __("Shape of the icons", "themerex"),
							"value" => "square",
				...
				"trx_tabs" => array(
					...
					"children" => array(
						...
						"params" => array(
                            ...
                            "icon_before_title" => array(
                                "title" => __("Icon before title",  'themerex'),
                                "desc" => __('Select icon. Visible if the Tabs Style 2',  'themerex'),
                                "value" => "",
                                "type" => "icons",
                                "options" => $THEMEREX_GLOBALS['sc_params']['icons']
                            ),

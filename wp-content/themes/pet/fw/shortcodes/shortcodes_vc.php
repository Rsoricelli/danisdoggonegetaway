...
//			vc_remove_element("vc_accordion_tab");
			...
			vc_map( array(
				...
				"params" => array(
                    ...
                    array(
                        ...
                        "heading" => __("Icon before title", "themerex"),
                        "description" => __("Select icon. Visible if the Accordion Style 2", "themerex"),
                        "class" => "",
                        "value" => $THEMEREX_GLOBALS['sc_params']['icons'],
                        "type" => "dropdown"
                    ),
			...
			vc_map( array(
				...
				"params" => array(
					...
					array(
						...
						"description" => __("Description for the popup (then hover on the icon). You can use:<br>'{{' and '}}' - to make the text italic,<br>'((' and '))' - to make the text bold,<br>'||' - to insert line break", "themerex"),
						"class" => "",
						"value" => "",
						"type" => "textfield"
					),
			...
			vc_map( array(
				...
				"params" => array(
					...
					array(
						...
						"description" => __("Read more link text. If empty - show 'More info', else - used as link text", "themerex"),
						"group" => __('Details', 'themerex'),
						"class" => "",
						"value" => "",
						"type" => "textfield"
			...
			vc_map( array(
				...
				"name" => __("Call to Action", "themerex"),
				"description" => __("Insert call to action block in your page (post)", "themerex"),
				"category" => __('Content', 'js_composer'),
				...
				"params" => array(
					array(
						"param_name" => "style",
						"heading" => __("Block's style", "themerex"),
						"description" => __("Select style to display this block", "themerex"),
						"class" => "",
						"admin_label" => true,
						"value" => array_flip(themerex_get_list_styles(1, 2)),
						"type" => "dropdown"
					...
					array(
						"param_name" => "accent",
						"heading" => __("Accent", "themerex"),
						"description" => __("Fill entire block with Accent1 color from current color scheme", "themerex"),
						"class" => "",
					...
					array(
						...
						"description" => __("Allow get featured image or video from inner shortcodes (custom) or get it from shortcode parameters below", "themerex"),
						"class" => "",
					...
					array(
						...
						"description" => __("Image to display inside block", "themerex"),
				        'dependency' => array(
							'element' => 'custom',
							'is_empty' => true
						),
					...
					array(
						...
						"description" => __("Paste URL for video file to display inside block", "themerex"),
				        'dependency' => array(
							'element' => 'custom',
							'is_empty' => true
						),
					...
					array(
						"param_name" => "link2",
						"heading" => __("Button 2 URL", "themerex"),
						"description" => __("Link URL for the second button at the bottom of the block", "themerex"),
						"group" => __('Captions', 'themerex'),
						"class" => "",
						"value" => "",
						"type" => "textfield"
					...
					array(
						...
						"heading" => __("Button 2 caption", "themerex"),
						"description" => __("Caption for the second button at the bottom of the block", "themerex"),
						"group" => __('Captions', 'themerex'),
						"class" => "",
						"value" => "",
						"type" => "textfield"
			...
			vc_map( array(
				...
				"params" => array(
					...
					array(
						...
						"description" => __("Select style of the contact form", "themerex"),
						"admin_label" => true,
						"class" => "",
						"value" => array_flip(themerex_get_list_styles(1, 2)),
						"type" => "dropdown"
			...
			vc_map( array(
				...
				"name" => __("Googlemap marker", "themerex"),
				"description" => __("Insert new marker into Google map", "themerex"),
				...
				"params" => array(
					array(
						...
						"description" => __("Address of this marker", "themerex"),
						"admin_label" => true,
						"class" => "",
						"value" => "",
						"type" => "textfield"
					...
					array(
						...
						"description" => __("Comma separated marker's coorditanes (instead Address)", "themerex"),
						"admin_label" => true,
						"class" => "",
						"value" => "",
						"type" => "textfield"
					...
					array(
						"param_name" => "title",
						"heading" => __("Title", "themerex"),
						"description" => __("Title for this marker", "themerex"),
						"admin_label" => true,
						"class" => "",
						"value" => "",
						"type" => "textfield"
					...
					array(
						"param_name" => "point",
						"heading" => __("URL for marker image file", "themerex"),
						"description" => __("Select or upload image or write URL from other site for this marker. If empty - use default marker", "themerex"),
						"class" => "",
						"value" => "",
						"type" => "attach_image"
					),
			...
			vc_map( array(
				...
				"params" => array(
					...
					array(
						...
						"description" => __("The link URL from the image", "themerex"),
						"admin_label" => true,
						"class" => "",
						"value" => "",
						"type" => "textfield"
			...
			vc_map( array(
				...
				"params" => array(
                    ...
                    array(
                        "param_name" => "color",
                        "heading" => __("Color background", "themerex"),
                        "description" => __("Select color background for this block", "themerex"),
                        "group" => __('Colors and Images', 'themerex'),
                        "class" => "",
                        "value" => "",
                        "type" => "colorpicker"
			...
			vc_map( array(
				...
				"params" => array(
                    ...
                    array(
                        "param_name" => "style",
                        "heading" => __("Style quote", "themerex"),
                        "description" => __("Select design", "themerex"),
			...
			vc_map( array(
				...
				"params" => array(
					...
					array(
						"param_name" => "state",
						"heading" => __("State", "themerex"),
						"description" => __("Select search field initial state", "themerex"),
						"class" => "",
						"value" => array(
							__('Fixed', 'themerex')  => "fixed",
							__('Opened', 'themerex') => "opened",
							__('Closed', 'themerex') => "closed"
						),
						"type" => "dropdown"
					),
					array(
			...
			vc_map( array(
				...
				"params" => array(
					...
					array(
						...
						"heading" => __("Arc caption", "themerex"),
						"description" => __("Arc caption - text in the center of the diagram", "themerex"),
						'dependency' => array(
							'element' => 'type',
							'value' => array('arc')
						),
					...
					array(
						...
						"heading" => __("Pie compact", "themerex"),
						"description" => __("Show all skills in one diagram or as separate diagrams", "themerex"),
						'dependency' => array(
							'element' => 'type',
							'value' => array('pie')
						),
						"class" => "",
						"value" => array(__('Show all skills in one diagram', 'themerex') => 'on'),
						"type" => "checkbox"
					),
					array(
						"param_name" => "pie_cutout",
						"heading" => __("Pie cutout", "themerex"),
						"description" => __("Pie cutout (0-99). 0 - without cutout, 99 - max cutout", "themerex"),
						'dependency' => array(
							'element' => 'type',
							'value' => array('pie')
						),
			...
			vc_map( array(
				...
				"params" => array(
					...
					array(
						"param_name" => "style",
						"heading" => __("Counter style", "themerex"),
					...
					array(
						"param_name" => "icon",
						"heading" => __("Counter icon", "themerex"),
						"description" => __("Select icon from Fontello icons set, placed before counter (only for type=counter)", "themerex"),
						"class" => "",
						"value" => $THEMEREX_GLOBALS['sc_params']['icons'],
						"type" => "dropdown"
					),
			...
			vc_map( array(
				...
				"params" => array_merge(array(
					array(
						...
						"description" => __("Type of the icons - images or font icons", "themerex"),
						"class" => "",
...
//                        ),
					...
					array(
						"param_name" => "shape",
						"heading" => __("Icon's shape", "themerex"),
						"description" => __("Shape of the icons", "themerex"),
						"class" => "",
			...
			vc_map( array(
				...
				"params" => array(
                    ...
                    array(
                        "param_name" => "icon_before_title",
                        "heading" => __("Icon before title", "themerex"),
                        "description" => __("Select icon. Visible if the Tabs Style 2", "themerex"),
                        "class" => "",
                        "value" => $THEMEREX_GLOBALS['sc_params']['icons'],
                        "type" => "dropdown"
                    ),

		...
		if (!isset($THEMEREX_GLOBALS['shortcodes_prepared'])) {
			...
			<script type="text/javascript">
				jQuery(document).ready(function(){
					try {
						THEMEREX_GLOBALS['shortcodes'] = eval(<?php echo json_encode( themerex_array_prepare_to_json($THEMEREX_GLOBALS['shortcodes']) ); ?>);
					} catch (e) {}
					THEMEREX_GLOBALS['shortcodes_cp'] = '<?php echo is_admin() ? 'wp' : 'custom'; ?>';	// wp | tiny | custom
				});
			</script>
			<?php
		}

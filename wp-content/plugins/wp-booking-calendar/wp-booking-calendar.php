...
function booking_calendar_public_scripts() {
    ...
    wp_enqueue_script('jquery');
    wp_enqueue_style('wp-booking-calendar-public-font-awesome-css',plugins_url('wp-booking-calendar/public/css/font-awesome/css/font-awesome.min.css'));
...
function wp_booking_shortcode_add() {
	...
	//load_plugin_textdomain( 'wp-booking-calendar', false, dirname( plugin_basename(__FILE__) ) . '/lang/' );
...
/*add_action('plugins_loaded', 'wp_booking_calendar_load_textdomain');
function wp_booking_calendar_load_textdomain() {
	load_plugin_textdomain( 'wp-booking-calendar', false, dirname( plugin_basename(__FILE__) ) . '/lang/' );
}*/

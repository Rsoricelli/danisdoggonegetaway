...
<div id="wp_booking_calendar_main_container">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function getMonthName(month,year) {
            var m = new Array();
            m[0] ="<?php echo __( 'January', 'wp-booking-calendar' ); ?>";
            m[1] ="<?php echo __( 'February', 'wp-booking-calendar' ); ?>";
            m[2] ="<?php echo __( 'March', 'wp-booking-calendar' ); ?>";
            m[3] ="<?php echo __( 'April', 'wp-booking-calendar' ); ?>";
            m[4] ="<?php echo __( 'May', 'wp-booking-calendar' ); ?>";
            m[5] ="<?php echo __( 'June', 'wp-booking-calendar' ); ?>";
            m[6] ="<?php echo __( 'July', 'wp-booking-calendar' ); ?>";
            m[7] ="<?php echo __( 'August', 'wp-booking-calendar' ); ?>";
            m[8] ="<?php echo __( 'September', 'wp-booking-calendar' ); ?>";
            m[9] ="<?php echo __( 'October', 'wp-booking-calendar' ); ?>";
            m[10] ="<?php echo __( 'November', 'wp-booking-calendar' ); ?>";
            m[11] ="<?php echo __( 'December', 'wp-booking-calendar' ); ?>";
        ...
        function updateCalendarSelect(category) {
            $wbc.ajax({
              url: '<?php echo plugins_url('wp-booking-calendar/public');?>/ajax/getCalendarsList.php?category_id='+category+"&wpml_lang="+$wbc('#wpml_lang').val(),
        ...
        function updateCalendar(calendar_id) {
            $wbc.ajax({
              url: '<?php echo plugins_url('wp-booking-calendar/public');?>/ajax/getCalendar.php?calendar_id='+calendar_id+"&wpml_lang="+$wbc('#wpml_lang').val(),
              success: function(data) {
                                ...
                                function submitLogin() {
                                    if(Trim($wbc('#user_login') .val()) != '' && Trim($wbc('#user_pass').val()) != '') {
                                        ...
                                        $wbc.ajax({
                                            ...
                                            $wbc.ajax({
                                              url: '<?php echo plugins_url('wp-booking-calendar/public');?>/ajax/getCurrentUser.php?wpml_lang='+$wbc('#wpml_lang').val(),
                                              success: function(data) {
                                                  ...
                                                  if(data!='error') {
                                                      ...
                                                      alert("<?php echo __( 'Invalid username or password', 'wp-booking-calendar' ); ?>");
                                                  }
                                        ...
                                        alert("<?php echo __( 'Insert a valid username and password', 'wp-booking-calendar' ); ?>");
                                    }
                                }
                            </script>

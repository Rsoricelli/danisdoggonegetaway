...
if(!$bookingReservationObj->isPassed($_GET["reservations"])) {
	...
	$message=__( 'A user has cancelled his reservation. Check it in the admin panel: ', 'wp-booking-calendar' ).'<a href="'.plugins_url('wp-booking-calendar/admin').'/reservations.php">'.__( 'click here', 'wp-booking-calendar' ).'</a><br />';

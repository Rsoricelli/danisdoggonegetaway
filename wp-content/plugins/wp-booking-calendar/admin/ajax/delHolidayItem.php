...
<div id="table" class="booking_margin_t_20">
    	...
    	<div class="booking_border_b_1 booking_border_solid booking_border_ccc booking_bg_f6f booking_height_30 booking_line_30">
			...
			<div class="booking_float_left booking_width_70p"><?php echo __( 'Date', 'wp-booking-calendar' ); ?>&nbsp;<a href="?order_by=date&tipo=<?php echo $_SESSION["orderbyHolidayDate"]; ?>"><img src="<?php echo plugins_url('wp-booking-calendar/admin/');?>images/orderby_<?php echo $_SESSION["orderbyHolidayDate"];?>.gif" border=0 /></a></div>

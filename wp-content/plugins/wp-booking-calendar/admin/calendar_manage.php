...
if(isset($_POST["slot_hour_delete"])) {
	...
	?>
	<script>
        alert('<?php echo $numslots; ?> <?php echo __('slots deleted','wp-booking-calendar'); ?>');
		document.location.href="?page=wp-booking-calendar&calendar_id=<?php echo $_GET["calendar_id"]; ?>&ref=slots";
    </script>
    <?php
...
if(isset($_POST["slot_hour_edit"])) {
	...
	?>
	<script>
        alert('<?php echo $numslots; ?> <?php echo __('slots modified','wp-booking-calendar'); ?>');
		document.location.href="?page=wp-booking-calendar&calendar_id=<?php echo $_GET["calendar_id"]; ?>&ref=slots";
    </script>
    <?php
...
if(isset($_POST["slot_date_from"])) {	
	...
	<script>
		...
		if($numslots>0) {
			?>
			alert('<?php echo $numslots; ?> <?php echo __('slots added','wp-booking-calendar'); ?>');
			<?php
		} else if($numslots == -1) {
			?>
			alert('<?php echo __('Days selected are holidays. Cannot make these changes','wp-booking-calendar'); ?>');
			<?php
		} else {
			?>
			alert('<?php echo __('Duplicate slots. Cannot make these changes','wp-booking-calendar'); ?>');
			<?php
		}
		?>

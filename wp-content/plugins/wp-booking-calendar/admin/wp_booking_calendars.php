	...
	<div class="booking_padding_20 booking_font_14 booking_line_percent booking_bg_fff">
				...
				<script>
					...
					function delItem(itemId) {
						if(confirm("<?php echo __( 'Are you sure you want to delete this item? All holidays, slots and reservations will be deleted', 'wp-booking-calendar' ); ?>")) {
							$wbc.ajax({
					...
					function publishCalendar(itemId) {
						if(confirm("<?php echo __( 'Are you sure you want to publish this calendar?', 'wp-booking-calendar' ); ?>")) {
							$wbc.ajax({
					...
					function unpublishCalendar(itemId) {
						if(confirm("<?php echo __( 'Are you sure you want to unpublish this calendar?', 'wp-booking-calendar' ); ?>")) {
							$wbc.ajax({

...
<div class="booking_padding_20 booking_font_18 booking_line_percent booking_bg_fff">
        ...
        =======================
        -->
        <div class="booking_font_bold"><label for="timezone"><?php echo __('Timezone','wp-booking-calendar'); ?></label></div>
        <div class="booking_font_12"><?php echo __('Your timezone to manage the time slots','wp-booking-calendar'); ?></div>
       
        <div class="booking_font_12 booking_margin_t_10">
            <select name="timezone" id="timezone" tmt:invalidvalue="" tmt:required="true" tmt:message="<?php echo __('Select your timezone','wp-booking-calendar'); ?>">
